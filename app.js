...
const rollDie = function(sizeOfDice) {
  ...
  console.log(colors.blue(`You rolled a ${sizeOfDice} sided die with a result of ${result}`));
  return result;
}
...
if(process.argv[2] === undefined) {
  console.log(colors.red(`There are no arguments. Please enter two integer numbers as arguments in the format (node diceRoller.js [integer] [integer])`))
//check if there are not enough arguments
} else if(process.argv[3] === undefined) {
  console.log(colors.red(`There are not enough arguments. Please enter two integer numbers as arguments in the format (node diceRoller.js [integer] [integer])`))
//check if the argument is not an integer. Only run if two integer numbers are there.
  ...
  console.log(colors.red(`The first integer is not an integer. Please enter two integer numbers as arguments in the format (node diceRoller.js [integer] [integer])`));  
} else if(!Number.isInteger(Number(process.argv[3]))) {
  console.log(colors.red(`The second integer is not an integer. Please enter two integer numbers as arguments in the format (node diceRoller.js [integer] [integer])`));
} else {
